/* Here arrival time for all processes is assumed 0 */
...
public class Priority
{
	...
	Scanner s=new Scanner(System.in);
		...
		static void cal_time(Priority[] obj,int no)
		{
			...
			System.out.println("Total Turn Around time : "+count);
			System.out.println("Average TurnAround time :"+((float)count/no));
		}
